...
// name, handle, stars, clickable row that will eventually open the seller
// profile page. Uses the same lightweight useSeller hook as cards (not
// the full mpGetSeller with follower/deal counts), so — like SellerStrip —
// this intentionally does NOT render the trust-badge cluster
// (sellerBadgesHtml) yet. The "Seller Reveals" reviews sub-section from
// the original is a separate scoped follow-up, not included here.
  ...
  return (
    <div className="modal-section">
      ...
      <div
        ...
        onClick={() => {
          // Seller profile page isn't built yet — no-op until that step
          // lands (mpOpenSellerModal equivalent). Intentionally silent
          // rather than a dead link, matching how onOpenSeller is
          // scaffolded elsewhere in this codebase right now.
        }}
      >
